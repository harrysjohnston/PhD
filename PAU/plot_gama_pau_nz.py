...
plt.hist(pz[pr], range=(0,1.2), bins=60, color='r', ls='--', label='PAUS W3 red (Cigale 2-cluster)', **kw)
plt.hist(pz[~pr], range=(0,1.2), bins=60, color='b', ls='--', label='PAUS W3 blue (Cigale 2-cluster)', **kw)
