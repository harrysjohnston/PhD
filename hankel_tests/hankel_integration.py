...
def setup(options):
# CONSIDER WHERE COLOUR-SPECIFIC AMPLITUDES WILL BE APPLIED !!
	...
	stepsize_h = options.get_double(option_section, 'stepsize_h', default=None)
...
def execute(block, config):
	...
	if cf.intz:
		...
		xi_proj = np.trapz(xi.T * W, x=z, axis=1)
